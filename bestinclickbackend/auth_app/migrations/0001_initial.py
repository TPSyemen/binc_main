    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('store_owner', 'Store Owner'), ('admin', 'System Administrator')], default='customer', help_text='User role for access control', max_length=20)),
